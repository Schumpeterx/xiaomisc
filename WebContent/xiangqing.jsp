...
<!-- end banner_x -->
	...
	<div class="xiangqing">
		<div class="neirong w">
			<div class="xiaomi6 fl">购买${goods.gname}</div>
			<nav class="fr">
				<li><a href="">概述</a></li>
				<li>|</li>
				<li><a href="">变焦双摄</a></li>
	...
	<div class="jieshao mt20 w">
		<div class="left fl"><img src="${goods.gphoto}"></div>
		<div class="right fr">
			<div class="h3 ml20 mt20">${goods.gname}</div>
			<div class="jianjie mr40 ml20 mt10">${goods.gsign}</div>
			<div class="jiage ml20 mt10">${goods.gprice}元</div>
			...
			<div class="xqxq mt20 ml20">
				...
				<div class="bot mt20 ft20 ftbc">总计：${goods.gprice}元</div>
			</div>
