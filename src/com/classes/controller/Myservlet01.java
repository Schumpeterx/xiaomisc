...
public class Myservlet01 extends HttpServlet {
	...
	public void Scar(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("gouwuche1.jsp").forward(req, resp);
	}
}
